...
public class removememberCommand extends SubCommand {
    ...
    public String getSyntax() {
        return "/porman removemember <傳送門名字> <玩家名字>";
    }
    ...
    public void perform(CommandSender commandSender, String[] args) {
        ...
        portal.removeMember(target.getUniqueId());
        updatePortal(portal);
        p.sendMessage(prefix + " 成功從成員中移除 " + ChatColor.GREEN + target.getName() + ChatColor.WHITE + " 。");
